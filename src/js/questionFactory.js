class QuestionFactory {
    ...
    static createMultipleChoiceBreedQuestions(breeds, amount, animalType) {
        ...
        for (let i = 0; i < amount; i++) {
            ...
            var possibleAnswers = getUniqueSubset(breeds, 4, randomBreed.name);
    ...
    static createCatDogMultipleChoiceBreedQuestions(catBreeds, dogBreeds, amount) {
        ...
        for (let i = 0; i < amount; i++) {
            ...
            if (i % 2 === 0) {
                ...
                var possibleAnswers = getUniqueSubset(catBreeds, 4, randomBreed.name);
                ...
                var possibleAnswers = getUniqueSubset(dogBreeds, 4, randomBreed.name);
